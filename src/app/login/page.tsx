                ...
                <div className="max-w-md w-full relative">
                    ...
                    >
                        ...
                        <h1 className="text-4xl font-black text-white italic uppercase tracking-tighter mb-4">
                            Welcome <span className="text-secondary italic">Back.</span>
                        </h1>
                        <p className="text-sm text-muted-foreground font-medium uppercase tracking-widest mb-10">
                            The next big thing is one login away.
                        </p>
                        ...
                        <div className="w-full space-y-4">
                            ...
                            >
                                <Github className="w-5 h-5 mr-3 group-hover:scale-125 transition-transform" /> Continue with GitHub
                            </Button>
                            <Button
                            ...
                            >
                                <Mail className="w-5 h-5 mr-3 text-secondary group-hover:scale-125 transition-transform" /> Continue with Google
                            </Button>
                        </div>
                        ...
                        <div className="flex flex-col gap-6 w-full text-center">
                            <div className="flex flex-wrap justify-center gap-2">
                                <Badge variant="ghost" className="bg-white/5 border border-white/5 text-[9px] font-black uppercase tracking-widest py-1.5 px-3">2,400+ BUILDERS</Badge>
                                <Badge variant="ghost" className="bg-white/5 border border-white/5 text-[9px] font-black uppercase tracking-widest py-1.5 px-3">890+ PROJECTS</Badge>
                            </div>
                            <p className="text-xs text-muted-foreground font-medium">
                                Don't have an account? <br />
                                <button onClick={() => router.push("/register")} className="text-primary font-bold uppercase tracking-widest mt-2 hover:underline">Launch Profile →</button>
                            </p>
                        </div>
                    </motion.div>
                </div>
