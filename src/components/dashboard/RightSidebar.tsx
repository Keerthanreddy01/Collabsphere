    ...
    return (
        <div className="flex flex-col gap-6">
            ...
            <div className="space-y-3">
                <h3 className="text-[12px] font-semibold text-[#7d8590] uppercase tracking-wide">Collab Requests</h3>
                    ...
                    {[
                        ...
                        <div key={i} className="surface p-4 hover:bg-[#1c2128] transition-colors relative group">
                            ...
                            <div className="flex items-start gap-3 mb-3">
                                <Identicon name={app.user} size={28} />
                            ...
                            <div className="flex gap-2">
                                <button className="flex-1 px-3 py-1 bg-[#21262d] border border-[#30363d] rounded-[6px] text-[12px] font-medium text-[#e6edf3] hover:bg-[#30363d] hover:border-[#8b949e] transition-all">
                                    Review
                                </button>
                            </div>
                        </div>
            ...
            <div className="space-y-3">
                <h3 className="text-[12px] font-semibold text-[#7d8590] uppercase tracking-wide">Trending Tags</h3>
